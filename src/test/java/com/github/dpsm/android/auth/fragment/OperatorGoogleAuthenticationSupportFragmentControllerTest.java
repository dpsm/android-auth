...
public class OperatorGoogleAuthenticationSupportFragmentControllerTest extends TestCase {
    ...
    public void givenNullActivityWhenInstantiatedThenThrows() {
        new OperatorGoogleAuthenticationSupportFragmentController(null, 0);
    }
    ...
    public void givenObservableEmitsTokenWhenSubscribedThenListenerCalled() throws IOException, GoogleAuthException {
        ...
        final Observable<String> observable = Observable.create(onSubscribe)
                .lift(new OperatorGoogleAuthenticationSupportFragmentController(fragment, 0));
    ...
    public void givenObservableThrowsUserRecoverableAuthExceptionWhenSubscribedAndUserResolvesThenListenerCalled() throws Exception {
        ...
        final OperatorGoogleAuthenticationSupportFragmentController controller
                = new OperatorGoogleAuthenticationSupportFragmentController(fragment, 0);
